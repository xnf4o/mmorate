...
@section('content')
	...
	<span class="btn-group pull-right m-l-20 p-1 bg-black-transparent-2 rounded">
	  <a href="#" class="btn btn-sm btn-white btn-white-without-border" data-change="widget-theme" data-theme="light"><i class="fa fa-sun text-primary"></i> Light</a>
	...
	<div class="row row-space-30">
		...
		<div class="col-sm-6 col-lg-4">
			...
			<div class="widget-map widget-map-rounded m-b-30" data-id="widget">
				...
				<div class="widget-input-container">
					<div class="widget-input-icon"><a href="#" class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white"><i class="fa fa-ellipsis-v"></i></a></div>
					<div class="widget-input-box">
						<input type="text" class="form-control form-control-sm" placeholder="Search here">
					</div>
					<div class="widget-input-icon"><a href="#" class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white"><i class="fa fa-microphone"></i></a></div>
					<div class="widget-input-divider"></div>
			...
			<div class="row m-b-30">
				...
				<div class="col-lg-6">
					<div class="clearfix">
						...
						<div class="widget-icon rounded bg-primary pull-left m-r-5 m-b-5 text-white">
				...
				<div class="col-lg-3 col-md-6">
					<a href="#" class="widget-card widget-card-rounded square m-b-5">
						<div class="widget-card-cover" style="background-image: url(../assets/img/login-bg/login-bg-7-thumb.jpg)">
							<span class="widget-card-cover-icon"><i class="fa fa-play"></i></span>
						</div>
					</a>
...
&lt;div class="widget-icon rounded <span class="hljs-string" data-id="widget-doc" data-dark-doc="bg-inverse text-white-transparent-5" data-light-doc="bg-muted text-white">bg-muted text-white</span> user"&gt;
...
@push('scripts')
	...
	<script src="/assets/js/demo/widget.demo.min.js"></script>
