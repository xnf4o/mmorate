                    ...
                    <form action="{{ route('editServer.post', $server->id) }}" method="post" id="editServerForm">
                        ...
                        <div class="leftBlockLk">
                            @if(isset($server->worlds))
                                <div class="block-select-lk">
                                    ...
                                    @foreach($server->worlds as $world)
                                        <b><a href="{{ route('editWorld', $world->id) }}">{{ $world->name }}
                                                [x{{ $world->rate }}]</a></b> <br><br>
                                    @endforeach
                                </div>
                            @endif
                            <div class="block-select-lk">
                            ...
                            <div class="form-group-lk">
                                ...
                                <input type="text" class="text-ing-lk" name="name" alt="Название игрового сервера"
                                       value="{{ $server->name }}" required minlength="3">
                            </div>
                            <div class="block-select-lk">
                            ...
                            <div class="form-group-lk">
                                ...
                                <input type="url" class="text-ing-lk" name="site" value="{{ $server->site }}" required>
                            </div>
                            <div class="form-group-lk">
                        ...
                        <div class="text-area-lk">
                            ...
                            <textarea class="textarea-style-lk"
                                      name="description" required minlength="30">{{ $server->description }}</textarea>
                        </div>
                        <div class="text-area-lk">
                        ...
                        @if($server->status == \MMORATE\Servers::CONFIRMED)
                            <button type="button" class="create-server"
                                    onclick="location.href='{{ route('stopServer', $server->id) }}'">Приостановить ›
                            </button>
                        @else
                            <button type="button" class="create-server"
                                    onclick="location.href='{{ route('startServer', $server->id) }}'">Возобновить ›
                            </button>
                        @endif
                        <button type="button" class="create-server"
                                onclick="location.href='{{ route('deleteServer', $server->id) }}'">Удалить ›
                        </button>
                    </form>
                </div>
            </div>
