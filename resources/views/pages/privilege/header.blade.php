        ...
        <div class="contentLeft">
            ...
            <div class="top-server-list">
                <div class="title-list-lk">
                    <h1><i class="ico-title"><img src="/img/icon/ico-1.png" alt=""></i>Премиум услуги</span></h1>
                    <div class="clear"></div>
                </div>
                <div class="content-lk-block content-premium">
                    <h3>Покупка биннера для шапки на странице топов</h3>
                    <p>
                        Прикрепите картинку в формате <span>JPEG, PNG или GIF</span>, введите E-mail для оповещения о
                        готовности и
                        нажмите на кнопку “Оплатить услугу”. Максимальное разрешение баннера: <span>2048х3690</span>
                        пикселей.
                    </p>
                </div>
                <div class="line-premium-vnut"></div>
                <div class="content-lk-block">
                    <form action="{{ route('privileges.buy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
