            ...
            <div class="contentLeft">
                ...
                <div class="top-server-list">
                    <div class="title-list-lk">
                        <h1><i class="ico-title"><img src="/img/icon/l-9.png" alt=""></i>Статистика голосования за сервер {{ $server->name }}</h1>
                        <div class="clear"></div>
                    </div>
                    <div class="content-lk-block">
                        <div class="material-block">
                            ...
                            <p style="text-align: left;">
                                ...
                                <b>• IP адрес</b> - ip-адрес проголосовавшего в формате ipv6 (например 145.45.25.10) <br>
                                <b>• Имя персонажа (или логин аккаунта)</b> - имя персонажа или логин аккаунта проголосовавшего <br>
                                <b>• Тип</b> - тип голоса: 1 - обычный голос, 2 - VIP голос
                            </p>
                            <p class="line-razdel"></p>
                            <div class="gameVibor">
                                <p style="margin-bottom: 0;">Статистика обновляется каждый час. Обнуляется ежемесячно, в ночь на первое число.</p>
                                <h3 style="margin-top: 0;">Для просмотра месячной статистики выберите проект из списка:</h3>
                                @foreach($allServers as $server)
                                    <div class="itemProfil_bn">
                                        <a href="{{ route('serverStat', $server->id) }}" class="myServerLink">{{ $server->name }}</a>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="item-top ">
                        <div class="tableStatistic">
                            <table>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" width="100%" style="text-align: center">Еще нет ни одного голоса</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
