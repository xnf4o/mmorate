                ...
                @if(auth()->user()->email_confirmed == 1 and auth()->user()->phone_confirmed == 1)
                    ...
                    <form action="{{ route('voteServerVip.post', $server->id) }}" method="post">
                        ...
                        <div class="info-vip-block">
                            ...
                            • Стоимость <span class="summ-golos">30 RUB</span> (российских) <br>
                            • Добавляет 3 голоса в копилку вашего сервера  <br>
                            • Может быть использован 1 раз в сутки с одной учетной записи VK <br>
                            • Размер вознаграждения за VIP голос, устанавливается администраторами вашего игрового портала
                        </div>
                        <div class="form-group-golos">
