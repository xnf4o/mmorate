...
@section('title', 'Подтверждение аккаунта')
@section('content')
            ...
            <div class="contentLeft">
                ...
                <div class="top-server-list">
                    <div class="title-list-lk">
                        <h1><i class="ico-title"><img src="/img/icon/i-22.png" alt=""></i><span>Подтверждение по СМС и E-mail</span></h1>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="podtverz-block" id="emblck">
                        ...
                        <div class="group-block-inp-pod">
                            ...
                            <form id="form-1">
                                ...
                                <input type="text" class="input-pod-content" value="{{ auth()->user()->email }}" id="mail">
                    ...
                    <div class="podtverz-block-2" id="phnblck">
                        ...
                        <div class="group-block-inp-pod">
                            ...
                            <form id="form-2">
                                ...
                                <input type="text" class="input-pod-content" name="phone" id="phone" value="{{ auth()->user()->phone }}">
